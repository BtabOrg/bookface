...
import ac.uk.bbk.bookface.web.ApplicationConversionServiceFactoryBean;
...
privileged aspect ApplicationConversionServiceFactoryBean_Roo_ConversionService {
    ...
    public Converter<Author, String> ApplicationConversionServiceFactoryBean.getAuthorToStringConverter() {
        return new org.springframework.core.convert.converter.Converter<ac.uk.bbk.bookface.domain.Author, java.lang.String>() {
    ...
    public Converter<Long, Author> ApplicationConversionServiceFactoryBean.getIdToAuthorConverter() {
        return new org.springframework.core.convert.converter.Converter<java.lang.Long, ac.uk.bbk.bookface.domain.Author>() {
            public ac.uk.bbk.bookface.domain.Author convert(java.lang.Long id) {
    ...
    public Converter<String, Author> ApplicationConversionServiceFactoryBean.getStringToAuthorConverter() {
        return new org.springframework.core.convert.converter.Converter<java.lang.String, ac.uk.bbk.bookface.domain.Author>() {
            public ac.uk.bbk.bookface.domain.Author convert(String id) {
    ...
    public Converter<Book, String> ApplicationConversionServiceFactoryBean.getBookToStringConverter() {
        return new org.springframework.core.convert.converter.Converter<ac.uk.bbk.bookface.domain.Book, java.lang.String>() {
            public String convert(Book book) {
                return new StringBuilder().append(book.getIdentifier()).append(' ').append(book.getTitle()).toString();
            }
        };
    }
    
    public Converter<Long, Book> ApplicationConversionServiceFactoryBean.getIdToBookConverter() {
        return new org.springframework.core.convert.converter.Converter<java.lang.Long, ac.uk.bbk.bookface.domain.Book>() {
            public ac.uk.bbk.bookface.domain.Book convert(java.lang.Long id) {
    ...
    public Converter<String, Book> ApplicationConversionServiceFactoryBean.getStringToBookConverter() {
        return new org.springframework.core.convert.converter.Converter<java.lang.String, ac.uk.bbk.bookface.domain.Book>() {
            public ac.uk.bbk.bookface.domain.Book convert(String id) {
    ...
    public Converter<Comments, String> ApplicationConversionServiceFactoryBean.getCommentsToStringConverter() {
        return new org.springframework.core.convert.converter.Converter<ac.uk.bbk.bookface.domain.Comments, java.lang.String>() {
            public String convert(Comments comments) {
                return new StringBuilder().append(comments.getIdentifier()).append(' ').append(comments.getDescription()).toString();
            }
        };
    }
    
    public Converter<Long, Comments> ApplicationConversionServiceFactoryBean.getIdToCommentsConverter() {
        return new org.springframework.core.convert.converter.Converter<java.lang.Long, ac.uk.bbk.bookface.domain.Comments>() {
            public ac.uk.bbk.bookface.domain.Comments convert(java.lang.Long id) {
    ...
    public Converter<String, Comments> ApplicationConversionServiceFactoryBean.getStringToCommentsConverter() {
        return new org.springframework.core.convert.converter.Converter<java.lang.String, ac.uk.bbk.bookface.domain.Comments>() {
            public ac.uk.bbk.bookface.domain.Comments convert(String id) {
    ...
    public Converter<Favourites, String> ApplicationConversionServiceFactoryBean.getFavouritesToStringConverter() {
        return new org.springframework.core.convert.converter.Converter<ac.uk.bbk.bookface.domain.Favourites, java.lang.String>() {
            public String convert(Favourites favourites) {
                return new StringBuilder().append(favourites.getIdentifier()).toString();
            }
        };
    }
    
    public Converter<Long, Favourites> ApplicationConversionServiceFactoryBean.getIdToFavouritesConverter() {
        return new org.springframework.core.convert.converter.Converter<java.lang.Long, ac.uk.bbk.bookface.domain.Favourites>() {
            public ac.uk.bbk.bookface.domain.Favourites convert(java.lang.Long id) {
    ...
    public Converter<String, Favourites> ApplicationConversionServiceFactoryBean.getStringToFavouritesConverter() {
        return new org.springframework.core.convert.converter.Converter<java.lang.String, ac.uk.bbk.bookface.domain.Favourites>() {
            public ac.uk.bbk.bookface.domain.Favourites convert(String id) {
    ...
    public Converter<Person, String> ApplicationConversionServiceFactoryBean.getPersonToStringConverter() {
        return new org.springframework.core.convert.converter.Converter<ac.uk.bbk.bookface.domain.Person, java.lang.String>() {
            public String convert(Person person) {
                return new StringBuilder().append(person.getEmailAddress()).toString();
            }
        };
    }
    
    public Converter<Long, Person> ApplicationConversionServiceFactoryBean.getIdToPersonConverter() {
        return new org.springframework.core.convert.converter.Converter<java.lang.Long, ac.uk.bbk.bookface.domain.Person>() {
            public ac.uk.bbk.bookface.domain.Person convert(java.lang.Long id) {
    ...
    public Converter<String, Person> ApplicationConversionServiceFactoryBean.getStringToPersonConverter() {
        return new org.springframework.core.convert.converter.Converter<java.lang.String, ac.uk.bbk.bookface.domain.Person>() {
            public ac.uk.bbk.bookface.domain.Person convert(String id) {
